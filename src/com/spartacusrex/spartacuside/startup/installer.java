...
import com.spartacusrex.spartacuside.startup.setup.assetextract;
...
public class installer extends Activity implements OnClickListener{
    ...
    public static int      CURRENT_INSTALL_SYSTEM_NUM  = 2;
    public static String   CURRENT_INSTALL_SYSTEM      = "System v1.2";
    public static String   CURRENT_INSTALL_ASSETFILE   = "system-1.2.tar.gz.mp3";
            ...
            Thread tt = new Thread(){
                public void run(){
                    ...
                    try {
                        ...
                        msg = new Message();
                        msg.getData().putString("info", "Preparing system-1.2 ..");
                        mInstallHandler.sendMessage(msg);
